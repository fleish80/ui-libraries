...
const EXAMPLE_DATA: Item[] = [
  ...
  { id: 7, name: 'Nitrogen', linkName: 'ynet', link: 'https://www.ynet.co.il/home/0,7340,L-8,00.html', bataryPercent: 68 },
  ...
  { id: 13, name: 'Aluminum', linkName: 'ynet', link: 'https://www.ynet.co.il/home/0,7340,L-8,00.html', bataryPercent: 39 },
...
export class InformationService {
  ...
  get(): Observable<Information> {
    return of(
      {
        columns: ['id', 'name', 'link', 'percentage'],
        items: EXAMPLE_DATA
      });
  }
}
